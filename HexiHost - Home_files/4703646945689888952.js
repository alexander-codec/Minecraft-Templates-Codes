...
var MouseStatsSharedControl = {
    ...
    mscg: function (a) { if (!this.msag() || this.mscb || !this.msal()) return !1; this.msam("", !1); this.msak(a); this.msae(); this.msax.init(); mousestats_Site = a; document && "complete" == document.readyState ? MouseStatsSharedControl.msbd() : this.mousestats_addEvtListener(window, "load", function () { MouseStatsSharedControl.msbd() }); this.msba(); this.mscb = !0 }, msak: function (a) {
        ...
        setTimeout(function () {
            "undefined" !== typeof MouseStats_DisableHeatmaps && !1 !== MouseStats_DisableHeatmaps || MouseStatsSharedControl.msah(); "undefined" !== typeof MouseStats_DisablePlaybacks && !1 !== MouseStats_DisablePlaybacks || MouseStatsSharedControl.msaf(); "undefined" !== typeof MouseStats_DisableFormAnalytics && !1 !== MouseStats_DisableFormAnalytics ||
            MouseStatsSharedControl.msaq(); "undefined" !== typeof MouseStats_DisableMicroSurveys && !1 !== MouseStats_DisableMicroSurveys || MouseStatsSharedControl.msac()
        }, 300)
    }, msag: function () {
    ...
    msah: function () {
        ...
        if (null !==
        MouseStatsSharedControl.j && MouseStatsSharedControl.j.fn.on) a(); else if (null !== document.getElementById("mouseStatsQInjection")) setTimeout(function () { MouseStatsSharedControl.msad(a) }, 200); else if ("undefined" !== typeof jQuery && jQuery.fn.on) MouseStatsSharedControl.j = jQuery, MouseStatsSharedControl.msad(a); else {
            var b = !1, c = document.getElementsByTagName("head")[0], d = document.createElement("script"); d.src = "//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"; "undefined" !== typeof MouseStats_GoogleBlocked &&
            MouseStats_GoogleBlocked && (d.src = "//code.jquery.com/jquery-1.9.1.min.js"); d.type = "text/javascript"; d.id = "mouseStatsQInjection"; d.onload = d.onreadystatechange = function () { if (!(b || this.readyState && "loaded" !== this.readyState && "complete" !== this.readyState)) { b = !0; d.onload = d.onreadystatechange = null; var c = jQuery.noConflict(!0); MouseStatsSharedControl.j = c; MouseStatsSharedControl.msad(a) } }; c.appendChild(d)
        }
    }, msaz: function (a) {
        var b = "MouseStats-" + a.replace(/\W/g, ""); if (null === document.getElementById(b)) {
            var c =
            "http://www2.mousestats.com/static/jstracking/" + a + ".js", d = "https://ssl.mousestats.com/static/jstracking/" + a + ".js"; a = document.createElement("script"); c = "https:" == location.protocol ? d : c; a.id = b; a.src = c; a.async = !0; a.type = "text/javascript"; document.body.appendChild(a)
        }
    ...
    }, isMicroSurveysLoaded: function () { return "undefined" !== typeof MouseStatsMicroSurveys && MouseStatsMicroSurveys.isLoaded ? !0 : !1 }, msba: function () { function a() { MouseStatsSharedControl.msao(!0) } this.mousestats_addEvtListener(window, "beforeunload", a); this.mousestats_addEvtListener(window, "unload", a) }, msbm: function (a, b, c) {
        var d = new Date; d.setDate(d.getDate() + c); var e = this.msas(); ".localhost" == e && (e = ""); b = escape(b) + (null == c ? "" : "; path=/; domain=" +
        e + "; expires=" + d.toUTCString()); document.cookie = a + "=" + b
        ...
        var e = !1; d || window.XDomainRequest || (e = !0); if (window.XMLHttpRequest && d || e) try { var h = new window.XMLHttpRequest; h.open("POST", a, !0); h.setRequestHeader("Content-type", "application/x-www-form-urlencoded"); h.onreadystatechange = function () { (4 == this.readyState && 200 == this.status || void 0 == this.readyState) && "function" == typeof c && c() }; h.send(b) } catch (k) { } else if (window.XDomainRequest) try {
            var g = new f.XDomainRequest; g.open("post", a); "function" == typeof c && (g.onload = c); g.onerror = function () { }; g.onprogress = function () { };
            g.ontimeout = function () { }; g.timeout = 6E3; setTimeout(function () { g.send(b) }, 200)
        } catch (k) { }
        ...
        var b = !1; try { b = b || MouseStatsVisitorPlaybacks.isLoaded } catch (c) { } try { b = b || MouseStatsHeatmaps.isLoaded } catch (c) { } try {
            b =
            b || MouseStatsFormAnalytics.isLoaded
        } catch (c) { } if (b) { try { MouseStatsVisitorPlaybacks.Stop() } catch (c) { } try { MouseStatsHeatmaps.Stop() } catch (c) { } try { MouseStatsFormAnalytics.Stop() } catch (c) { } try { MouseStatsSharedControl.msce(a) } catch (c) { } }
        ...
        function a(a,
        b) { MouseStats_Commands.push(["tag", a, b]) } var b = ""; 0 < this.msbf.msbz.length && (b += "[" + this.msbf.msbz.trim() + "]"); try { var c = window.ub.page.name; "number" != typeof c && "string" != typeof c || a("Unbounce-Name", c) } catch (g) { } try { c = window.ub.page.variantId, "number" != typeof c && "string" != typeof c || a("Unbounce-Variant", c) } catch (g) { } try { var d = window.optimizely.data.state.activeExperiments[0], c = d; "number" != typeof c && "string" != typeof c || a("Optimizely-ExperimentID", c) } catch (g) { } try {
            d = window.optimizely.data.state.activeExperiments[0],
            c = window.optimizely.data.state.variationNamesMap[d], "number" != typeof c && "string" != typeof c || a("Optimizely-VariationName", c)
        } catch (g) { } try { d = window.optimizely.data.state.activeExperiments[0], c = window.optimizely.data.state.variationIdsMap[d], "number" != typeof c && "string" != typeof c || a("Optimizely-VariationID", c) } catch (g) { } try { c = window.__variant, "number" != typeof c && "string" != typeof c || a("Instapage-Variant", c) } catch (g) { } if ("undefined" !== typeof MouseStats_Commands && 0 < MouseStats_Commands.length) {
            uniq = function (a,
            b) { var c = {}; return a.filter(function (a) { a = b ? b.apply(a) : a; return a in c ? !1 : c[a] = !0 }) }; MouseStats_Commands = uniq(MouseStats_Commands, [].join); c = ""; for (d = 0; d < MouseStats_Commands.length; d++) if (0 === MouseStats_Commands[d][0].indexOf("tag") || 0 === MouseStats_Commands[d][0].indexOf("identify")) try {
                var e = 2 < MouseStats_Commands[d].length ? MouseStats_Commands[d][1].trim() + ":" : "", h = 2 < MouseStats_Commands[d].length ? MouseStats_Commands[d][2].trim() : MouseStats_Commands[d][1].trim(), b = b + ("[" + (e + h) + "]"); 0 == MouseStats_Commands[d][0].indexOf("identify") &&
                0 < h.length && (c = "[_ms_identify:" + h.substring(0, 50) + "]")
            } catch (g) { } b += c
        } return b
    }, msbc: function () { this.msce(); this.msae() }, msae: function () { try { clearInterval(this.msbu[0]) } catch (a) { } this.msbu[0] = setInterval("MouseStatsSharedControl.msbc();", 8E3) }, msbl: function () { this.msbt = [[], [], []] }, msbw: function (a) { for (var b, c, d = document.cookie.split(";"), e = 0; e < d.length; e++) if (b = d[e].substr(0, d[e].indexOf("=")), c = d[e].substr(d[e].indexOf("=") + 1), b = b.replace(/^\s+|\s+$/g, ""), b == a) return unescape(c); return "" }, msal: function () {
        return "cookie" in
        document && (0 < document.cookie.length || -1 < (document.cookie = "cenable=yes; path=/;").indexOf.call(document.cookie, "cenable"))
    }, msaj: function () { for (var a = "", b = 0; 5 > b; b++) a += (65536 * (1 + Math.random()) | 0).toString(16).substring(1); return a }, msas: function () {
        var a = window.location.host; a.indexOf(":") && (a = a.split(":")[0]); if (/^([0-9]{1,3}).([0-9]{1,3}).([0-9]{1,3}).([0-9]{1,3})?(:([0-9]{1,5})|)$/.test(a)) return a; a = window.location.href; a = a.replace(/^http(s)?\:\/\/?/i, "").replace(/^([^\/]+)\/.*/i, "$1"); a = /\.gov\.|\.edu\.|\.ac\.|\.org\.|\.co\.|\.net\.|\.com\./.test(a) ?
        a.replace(/^([^\.]+\.){1,}([^\.]+\.[^\.]+\.[^\.]+)$/i, "$2") : a.replace(/^([^\.]+\.){1,}([^\.]+\.[^\.]+)$/i, "$2"); a.indexOf(":") && (a = a.split(":")[0]); return "." + a
        ...
        try {
            var c = !1; "undefined" == typeof b && (c = !0); if (c) return "undefined" == typeof localStorage["ms_" + a] ? "" : localStorage["ms_" + a]; localStorage["ms_" +
            a] = b; return !0
        } catch (d) { return "" }
        ...
        _keyStr: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", encode: function (a) {
            var b = "", c, d, e, h, g, k, l = 0; for (a = this._utf8_encode(a) ; l < a.length;) c = a.charCodeAt(l++), d = a.charCodeAt(l++), e = a.charCodeAt(l++), h = c >> 2, c = (c & 3) << 4 | d >> 4, g = (d & 15) << 2 | e >> 6, k = e & 63, isNaN(d) ?
            g = k = 64 : isNaN(e) && (k = 64), b = b + this._keyStr.charAt(h) + this._keyStr.charAt(c) + this._keyStr.charAt(g) + this._keyStr.charAt(k); return b.replace(/\+/g, "-").replace(/\//g, "_").replace(/\=/g, ",").replace(/A/g, "~")
    ...
    msax: {
        init: function () { this.browser = this.searchString(this.dataBrowser) || "unknown"; this.version = this.searchVersion(navigator.userAgent) || this.searchVersion(navigator.appVersion) || "unknown"; this.OS = this.searchString(this.dataOS) || "unknown" }, searchString: function (a) { for (var b = 0; b < a.length; b++) { var c = a[b].string, d = a[b].prop; this.versionSearchString = a[b].versionSearch || a[b].identity; if (c) { if (-1 != c.indexOf(a[b].subString)) return a[b].identity } else if (d) return a[b].identity } }, searchVersion: function (a) {
            var b =
            a.indexOf(this.versionSearchString); if (-1 != b) return parseFloat(a.substring(b + this.versionSearchString.length + 1))
        ...
        }], dataOS: [{ string: navigator.platform, subString: "Win", identity: "Windows" }, { string: navigator.platform, subString: "Mac", identity: "Mac" }, { string: navigator.userAgent, subString: "iPhone", identity: "iOS" }, { string: navigator.userAgent, subString: "iPad", identity: "iOS" }, { string: navigator.userAgent, subString: "iPod", identity: "iOS" }, { string: navigator.userAgent, subString: "Android", identity: "Android" }, { string: navigator.platform, subString: "Linux", identity: "Linux" }]
    }
};
MouseStatsSharedControl.mscg("4703646945689888952"); window.MouseStatsVisitorPlaybacks = []; window.MouseStatsVisitorPlaybacks.customVariable = function () { };
/* cached:12/27/2015 4:11:55 PM */