...
var createToaster = function(type, message) {
				id = successToaster.length;
				var img;
				var button;
				if (type=="success") {
					img='/static/img/tick_t.png';
					button="OK";
				} else if (type=="error") {
					img='/static/img/cross_t.png';
					button="CLOSE";
				} else{
					img='/static/img/warn_t.png';
					button="CLOSE";
				}
				
				successToaster[id] = new PNotify(
						{
							title : ' <div class="row text-center">'
									+ '<div class="img_div"> '
									+ '<img class="toaster_icon" src='+img+'> </div> '
									+ '<div class="large-12 medium-12 small-12 columns toast_title"> '+type.toUpperCase()+' </div>',
							text : ' <div class="large-12 medium-12 small-12 columns toast_msg text-center"> '
									+ message + ' </div> '
									+ ' <div class="large-12 medium-12 small-12 columns text-center"> '
									+ ' <button class="toast_button tiny round" onclick="successToaster['+id+'].remove();" >'+button+'</div> </div>',
							icon : false,
							type : type,
							delay : '5000',
							buttons : {
